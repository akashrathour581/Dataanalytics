    ...
    <div>
      ...
      {insights.length > 0 && (
        <div className="insights-card" style={{
          ...
          boxShadow: '0 10px 30px rgba(0, 0, 0, 0.4), 0 0 20px rgba(251, 191, 36, 0.15)'
        }}>
            ...
            {insights.map((insight, idx) => {
              ...
              return (
                <li key={idx} style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                  ...
                  <span style={{ color: '#e2e8f0', lineHeight: 1.6 }}>{insight}</span>
                </li>
              );
            })}
          </ul>
          ...
          <div className="chart-card col-8">
            <div className="chart-header">
              <div>
                ...
                <p className="chart-desc">{timeSeriesChart.description}</p>
              </div>
              <div style={{
                width: 38,
                height: 38,
                ...
                <LineIcon size={19} color="#38bdf8" style={{ filter: 'drop-shadow(0 0 4px #38bdf8)' }} />
              </div>
            </div>
          ...
          <div className={`chart-card ${timeSeriesChart ? 'col-4' : 'col-6'}`}>
            <div className="chart-header">
              <div>
                ...
                <p className="chart-desc">{pieChart.description}</p>
              </div>
              <div style={{
                width: 38,
                height: 38,
          ...
          return (
            <div key={bc.id || bIdx} className={`chart-card ${barCharts.length > 1 ? 'col-6' : 'col-12'}`}>
              <div className="chart-header">
                <div>
                  <h3 className="chart-title" style={{
                    background: `linear-gradient(135deg, #ffffff 30%, ${barTheme.col} 100%)`,
                    WebkitBackgroundClip: 'text',
                    WebkitTextFillColor: 'transparent',
                    fontWeight: 800
                  }}>
